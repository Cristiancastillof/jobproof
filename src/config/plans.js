...
export const JOBPROOF_PLANS = {
  [PLAN_KEYS.FREE_TRIAL]: {
    ...
    description:
      "Start using JobProof with the essential tools to test the workflow.",
    reportsLimit: 10,
    usersLimit: 1,
    clientsLimit: 5,
    isTrial: true,
  ...
  [PLAN_KEYS.STARTER]: {
    ...
    description:
      "For solo operators or very small teams starting to digitise reports.",
    reportsLimit: 30,
    usersLimit: 2,
    clientsLimit: 25,
    isTrial: false,
    highlighted: false,
    badge: null,
    stripePriceId: "price_1TgHr1GkCrT4hnBmGCiwPEJx",
    features: [
  ...
  [PLAN_KEYS.BUSINESS]: {
    ...
    highlighted: true,
    badge: "Most Popular",
    stripePriceId: "price_1TgHrmGkCrT4hnBmW9u6YhKT",
    features: [
  ...
  [PLAN_KEYS.PRO]: {
    ...
    billingLabel: "Monthly",
    description:
      "For growing teams with higher reporting volume and more staff.",
    reportsLimit: 500,
    usersLimit: 15,
    clientsLimit: null,
    isTrial: false,
    highlighted: false,
    badge: null,
    stripePriceId: "price_1TgHsOGkCrT4hnBmCgLOhEzt",
    features: [
  ...
  [PLAN_KEYS.ENTERPRISE]: {
    ...
    billingLabel: "Custom",
    description:
      "For companies that need custom volume, users, support or workflows.",
    reportsLimit: null,
    usersLimit: null,
    clientsLimit: null,
    isTrial: false,
